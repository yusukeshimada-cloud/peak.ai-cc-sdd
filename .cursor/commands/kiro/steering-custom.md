...
8. **ui-layout.md** - Common header, layout shell, shared UI parts
9. **report-standards.md** - Shared export/report formatting and file rules
10. **batch-standards.md** - Scheduled job execution, logging, retry rules
11. **glossary.md** - Shared terminology and project vocabulary
12. **spec-governance.md** - Feature ID, processing type, and difficulty rules
13. **operations.md** - Shared maintenance and operational policies
